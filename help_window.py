...
class HelpWindow(wx.Frame):
    def __init__(self, parent, id, title):
        ...
        close = wx.BitmapButton(header, -1, wx.Bitmap('images/close.png', wx.BITMAP_TYPE_PNG), 
		style=wx.NO_BORDER)
        ...
        helpl = html.HtmlWindow(self.panelLeft, -1, style=wx.NO_BORDER)
        helpl.LoadPage('help.html')
        vbox1.Add(helpl, 2, wx.EXPAND)
        self.panelLeft.SetSizer(vbox1)
        #self.panelLeft.SetFocus()
        
        help = html.HtmlWindow(self.panelRight, -1, style=wx.NO_BORDER)
        help.LoadPage('help1.html')
